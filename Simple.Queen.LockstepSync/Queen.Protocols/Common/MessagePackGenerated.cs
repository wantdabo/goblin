...
namespace MessagePack.Formatters.Queen.Protocols
{
    ...
    {
        // text
        private static global::System.ReadOnlySpan<byte> GetSpan_text() => new byte[1 + 4] { 164, 116, 101, 120, 116 };
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (stringKey.Length)
                {
                    ...
                    FAIL:
                      ...
                      continue;
                    case 4:
                        if (global::MessagePack.Internal.AutomataKeyGen.GetKey(ref stringKey) != 1954047348UL) { goto FAIL; }
...
{
    public sealed class ACKCrossMessageFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Queen.Protocols.Common.ACKCrossMessage>
    {
        // id
        private static global::System.ReadOnlySpan<byte> GetSpan_id() => new byte[1 + 2] { 162, 105, 100 };

        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Queen.Protocols.Common.ACKCrossMessage value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value is null)
            {
                writer.WriteNil();
        ...
        public global::Queen.Protocols.Common.ACKCrossMessage Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (reader.TryReadNil())
            {
                return null;
            ...
            var formatterResolver = options.Resolver;
            var length = reader.ReadMapHeader();
            var ____result = new global::Queen.Protocols.Common.ACKCrossMessage();
    ...
    public sealed class NodeErrorMsgFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Queen.Protocols.Common.NodeErrorMsg>
    {
        // code
        private static global::System.ReadOnlySpan<byte> GetSpan_code() => new byte[1 + 4] { 164, 99, 111, 100, 101 };
        // content
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Queen.Protocols.Common.NodeErrorMsg value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value is null)
            {
                writer.WriteNil();
        ...
        public global::Queen.Protocols.Common.NodeErrorMsg Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (reader.TryReadNil())
            {
                return null;
            ...
            var formatterResolver = options.Resolver;
            var length = reader.ReadMapHeader();
            var ____result = new global::Queen.Protocols.Common.NodeErrorMsg();
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (stringKey.Length)
                {
                    ...
                    case 4:
                        ...
                        ____result.code = reader.ReadUInt32();
                        continue;
                    case 7:
