...
namespace Queen.Protocols.Common
{
    public partial class ProtoPack
    {
        ...
        private static Dictionary<ushort, Type> messageDict = new()
        {
            ...
            { 10011, typeof(Queen.Protocols.Common.ACKCrossMessage)},
            { 10012, typeof(Queen.Protocols.Common.ReqCrossMessage)},
            { 10013, typeof(Queen.Protocols.Common.ResCrossMessage)},
