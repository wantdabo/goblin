...
public class PermissionRule : IProjectionRule
{
    ...
    /// </summary>
    private Dictionary<(ObserverType, Type), ulong> permtable { get; set; }

    public PermissionRule()
    {
        permtable = new Dictionary<(ObserverType, Type), ulong>();
    }
    ...
    public void Add(ObserverType observerType, Type behaviorInfoType, ulong allowedMask)
    {
