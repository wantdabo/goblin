...
namespace Goblin.SkillPipelineEditor
{
    ...
    {
        //**********  Welcome *********
        public static string Title = "GOBLIN 技能管线编辑器";
        public static string CreateAsset = "创建技能管线";
        public static string SelectAsset = "选择技能管线";
        public static string Seeting = "编辑器配置";


        //**********  Crate Window *********
        public static string CrateAssetType = "创建类型";
        public static string CrateAssetName = "技能管线名称";
        public static string CreateAssetFileName = "技能管线的文件名称";
        ...
        public static string CreateAssetTipsRepetitive = "已存在同名技能管线";
        ...
        public static string PreferencesScrollWheelZoomsTips = "是否开启滚轮缩放技能管线区域";
        ...
        //**********  Inspector *********
        public static string NotSelectAsset = "当前没有选中的技能管线对象。";
