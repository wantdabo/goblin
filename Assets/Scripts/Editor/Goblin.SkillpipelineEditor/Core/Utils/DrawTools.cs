...
namespace Goblin.SkillPipelineEditor
{
    public static class DrawTools
    {
        ...
        private static Dictionary<UnityEngine.AudioClip, Texture2D> audioTextures = new Dictionary<UnityEngine.AudioClip, Texture2D>();

        public static Texture2D GetAudioClipTexture(UnityEngine.AudioClip clip, int width, int height)
        {
            if (clip == null)
            {
                return null;
        ...
        public static void DrawLoopedAudioTexture(Rect rect, UnityEngine.AudioClip audioClip, float maxLength, float offset)
        {
            if (audioClip == null)
            {
                return;
