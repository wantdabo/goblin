...
namespace Goblin.SkillPipelineEditor
{
    ...
    public static class Styles
    {
        ...
        /// 第一个组上边距
        /// </summary>
        public const float FIRST_GROUP_TOP_MARGIN = 0;
        ...
        {
            stripes = (Texture2D)Resources.Load("Icon/Stripes");
            magnetIcon = (Texture2D)Resources.Load("Icon/magnet");
            lockIcon = (Texture2D)Resources.Load("Icon/LockIcon");
            hiddenIcon = (Texture2D)Resources.Load("Icon/HiddenIcon");
            playIcon = (Texture2D)Resources.Load("Icon/play");
            playForwardIcon = (Texture2D)Resources.Load("Icon/playForward");
            playBackwardIcon = (Texture2D)Resources.Load("Icon/playBackward");
            playLoopIcon = (Texture2D)Resources.Load("Icon/loopPlay");
            stepForwardIcon = (Texture2D)Resources.Load("Icon/stepForward");
            stepBackwardIcon = (Texture2D)Resources.Load("Icon/stepBackward");
            pauseIcon = (Texture2D)Resources.Load("Icon/pause");
            carretIcon = (Texture2D)Resources.Load("Icon/CarretIcon");
            cutsceneIconOpen = (Texture2D)Resources.Load("Icon/CutsceneIconOpen");
            settingsIcon = (Texture2D)Resources.Load("Icon/settings");
            backIcon = (Texture2D)Resources.Load("Icon/back");
            saveIcon = (Texture2D)Resources.Load("Icon/save");
            plusIcon = (Texture2D)Resources.Load("Icon/plus");
            menuIcon = (Texture2D)Resources.Load("Icon/menu");

            styleSheet = (GUISkin)Resources.Load("Icon/StyleSheet");
        }
