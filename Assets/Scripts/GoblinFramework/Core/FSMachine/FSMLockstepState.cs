...
namespace GoblinFramework.Core.FSMachine
{
    ...
    public abstract class FSMLockstepState<E, MT, ST> : FSMState<E, MT, ST> where E : GameEngine<E>, new() where MT : FSMachineLockstep<E, MT, ST>, new() where ST : FSMLockstepState<E, MT, ST>, new()
    {
        /// <summary>
