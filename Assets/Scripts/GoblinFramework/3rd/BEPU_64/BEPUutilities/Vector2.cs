...
namespace BEPUutilities
{
    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        {
            DistanceSquared(ref value1, ref value2, out Fix64 result);
            return Fix64.Sqrt(result);
        }


        public static void Distance(ref Vector2 value1, ref Vector2 value2, out Fix64 result)
        {
        ...
        public static void DistanceSquared(ref Vector2 value1, ref Vector2 value2, out Fix64 result)
        {
        ...
        /// Constructs a new two dimensional vector.
        /// </summary>
        /// <param name="val">val component of the (val, val)vector.</param>
        public Vector2(Fix64 val) : this(val, val){ }
