...
namespace GoblinFramework.Gameplay.Physics
{
    ...
    public class QuadTree : PComp
    {
        ...
        private Dictionary<ShapeCollider, Quad> shapeQuadDict;

        public void Add2QuadTree(ShapeCollider shape2d) 
        {
            if (null == shapeQuadDict) shapeQuadDict = new Dictionary<ShapeCollider, Quad>();
            if (shapeQuadDict.ContainsKey(shape2d)) throw new Exception("repeat. plz check.");
            // TODO 插入树中
        }

        public void Rmv4QuadTree(ShapeCollider shape2d) 
        {
        ...
        public void QuadTreeDirty(ShapeCollider shape2d) 
        {
        ...
        public void CheckPlace(ShapeCollider resident, Quad quad) 
        {
        }

        public Quad GetQuad(ShapeCollider shape2d) 
        {
        ...
        public List<ShapeCollider> GetNeighbor(ShapeCollider shape2d) 
        {
            List<ShapeCollider> shapeList = new List<ShapeCollider>();
        ...
        public class Quad : Goblin<PGEngine>
        {
            ...
            /// 该节点下的所有物体
            /// </summary>
            public List<ShapeCollider> shapeList;
