...
namespace Goblin.Gameplay.Render.Common
{
    ...
    public class AnimationMixConfig : ScriptableObject
    {
        ...
        [LabelText("动画配置信息列表")]
        [TableMatrix]
        public List<AnimationMixInfo> animations;
        ...
        public AnimationMixInfo GetAnimationInfo(byte state)
        {
    ...
    public class AnimationMixInfo
    {
        ...
        /// </summary>
        [LabelText("状态")]
        [ValueDropdown("@OdinDefineValueDropdown.GetStateDefine()")]
        public byte state;
        /// <summary>
        /// 动画名称
        /// </summary>
        ...
        public AnimationBeforeMixInfo GetMixAnimationInfo(byte state)
        {
