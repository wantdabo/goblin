...
namespace TrueSync
{
    ...
    public struct TSQuaternion
    {
        ...
        public TSVector eulerAnglesNew
        {
            get
            {
                FP r11 = 2 * (this.x * this.z + this.w * this.y);
                FP r12 = this.w * this.w - this.x * this.x - this.y * this.y + this.z * this.z;
                FP r21 = -2 * (this.y * this.z - this.w * this.x);
                FP r31 = 2 * (this.x * this.y + this.w * this.z);
                FP r32 = this.w * this.w - this.x * this.x + this.y * this.y - this.z * this.z;
                return new TSVector(FP.Atan2(r11, r12), FP.Asin(r21), FP.Atan2(r31, r32));
            }
        }
        ...
        {
            if (!(obj is TSQuaternion)) return false;
